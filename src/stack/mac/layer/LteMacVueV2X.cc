...
// In V2X mode 4 we aren't interacting with the eNb so this isn't necessary I don't think.
...
// Definitely need this. When we have the info we want to trasmit it must be first encased in a mac pdu
// before sending it to the Phy layer where it is encased in an AirFrame message.
void LteMacUeRealisticD2D::macPduMake()
{
    ...
    // In mode 4: Is it a downlink grant? I think so yes, therefore this doesnt apply.
